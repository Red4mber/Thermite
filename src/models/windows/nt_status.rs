...
// Default display implementation to make your life easier when trying to print it
// I should probably impl From_u32 or something like that too
...
// I needed to make a choice, they're all duplicates and you can't have those in an enum
/*
StatusWait0 = 0x0,
StillActive = 0x103,
