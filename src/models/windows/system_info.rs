...
//
// It is literally just the output of `dt nt!_SYSTEM_INFORMATION_CLASS` on WinDng, with some formatting magic to make it into an actual rust enum
// Tried hard to get hex values but dt sucks ass
